...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AMyProject3Character_Statics::NewProp_BaseLookUpRate = { "BaseLookUpRate", nullptr, (EPropertyFlags)0x0010000000020015, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AMyProject3Character, BaseLookUpRate), METADATA_PARAMS(Z_Construct_UClass_AMyProject3Character_Statics::NewProp_BaseLookUpRate_MetaData, ARRAY_COUNT(Z_Construct_UClass_AMyProject3Character_Statics::NewProp_BaseLookUpRate_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_AMyProject3Character_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_AMyProject3Character_Statics::PropPointers),
		0,
		0x008000A0u,
		METADATA_PARAMS(Z_Construct_UClass_AMyProject3Character_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_AMyProject3Character_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(AMyProject3Character, 2309824536);
